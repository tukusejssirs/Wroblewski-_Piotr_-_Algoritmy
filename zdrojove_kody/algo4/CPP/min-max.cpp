...
if (left==right)
	...
	else
	{
	 ...
	 // min=temp_min1<temp_min2 ? temp_min1 : temp_min2; // (1) bardziej zwiêz³a forma w stylu C
	 // max=temp_max1>temp_max2 ? temp_max1 : temp_max2; // (2) bardziej zwiêz³a forma w stylu C
